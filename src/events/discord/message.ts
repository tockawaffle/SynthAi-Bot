...
import getRegChannels from "../../configs/database/functions/getRegChannels";
...
module.exports = {
    ...
    async execute(message: Message, client: Client) {
        ...
        const getFollowUp = getRegChannels(author, thisChn);
        ...
        if (getFollowUp) {
            ...
            if (moderation.flagged) {
                ...
                return message.channel.send({
                    content: `${client.translate(author, "defaults", "moderationFlagged")} ${flagsString}.`,
                    reply: {
